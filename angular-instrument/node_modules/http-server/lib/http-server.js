...
function HttpServer(options) {
  ...
  var absolute_path = "/home/marco/DataArchive/angular-instrument/app/server-side/";
  before.push(function (req, res) {
    ...
    //console.log(req.url);
    //var child = childProcess.execFile("python", [absolute_path + "generate_hello_world.py", absolute_path], function(error, stdout, stderr){
    //  console.log(stdout);
    //});
    if (req.url == "/server-side/generate_hello_world.py") {
      childProcess.execFileSync("python", [absolute_path + "generate_hello_world.py", absolute_path]);
    }
    res.emit('next');
  });
