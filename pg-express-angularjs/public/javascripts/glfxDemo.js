...
Filter.prototype.use = function() {
    ...
    var image_array = ['varmdo-small.jpg', 'liverpool-telescope-small.jpg', 'north-berwick-small.jpg'];
    var random_image_array_id = image_array[Math.floor(Math.random() * image_array.length)];
    var image = images[this.imageFile || random_image_array_id];
    console.log(this);
    console.log(images[random_image_array_id]);
...
var images = {
    'varmdo-small.jpg': { credit: 'MCL', url: '../images/clam.jpg' },
    'north-berwick-small.jpg': { credit: 'MCL', url: '../images/clam.jpg' },
    'liverpool-telescope-small.jpg': { credit: 'MCL', url: '../images/clam.jpg' }
};
...
var filters = {
    'Adjust': [
        ...
        new Filter('Curves', 'curves', function() {
            this.addSlider('red', 'Red', -0.5, 0.5, 0.0, 0.01);
            this.addSlider('green', 'Green', -0.5, 0.5, 0.0, 0.01);
            this.addSlider('blue', 'Blue', -0.5, 0.5, 0.0, 0.01);
        }, function() {
            this.setCode('canvas.draw(texture).curves([[0.0,0.0],[0.5,' + (0.5+this.red) + '],[1.0,1.0]],[[0.0,0.0],[0.5,' + (0.5+this.green) + '],[1.0,1.0]],[[0.0,0.0],[0.5,' + (0.5+this.blue) + '],[1.0,1.0]]).update();');
        }),
